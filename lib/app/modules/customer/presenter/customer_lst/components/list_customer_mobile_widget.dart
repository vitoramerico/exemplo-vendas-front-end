...
class ListCustomerMobileWidget extends StatelessWidget {
  final CustomerLstController controller;

  const ListCustomerMobileWidget({Key? key, required this.controller}) : super(key: key);
  ...
  Widget _buidRow(CustomerEntity value) => ListTile(
        ...
        onTap: () {
          if (controller.closeOnClick)
            ...
            controller.openCustomerAdd(id: value.id);
        },
      );
